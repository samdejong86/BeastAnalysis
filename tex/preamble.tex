...
{
\includegraphics[height=0.5in]{img/belle2-logo.pdf}\hspace{0.5cm}\includegraphics[height=0.5in]{img/BeastLogo}\hspace{0.5cm}\includegraphics[height=0.5in]{img/UVic_Logo}
